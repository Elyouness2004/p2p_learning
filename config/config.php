<?php
// config/config.php
// Centralised configuration — DB connection + app constants
// Include this file ONCE at the top of every page via require_once
...
// Kill sessions idle for longer than SESSION_TIMEOUT seconds.
